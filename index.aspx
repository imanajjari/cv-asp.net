<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="section_3._1.index" %>
    ...
    >
      ...
      <div class="container">
        ...
        >
          ...
          <div class="mb-5">
                    <asp:Button ID="Button1" runat="server" Text="ایمان نجاری" class="btn-secondary-nobg w-full py-3"   />
          </div>
              <div class="mb-5">
                    <asp:Button ID="Button2" runat="server" Text="مهسا عبادپور" class="btn-secondary-nobg w-full py-3"  />
          </div>
              <div class="mb-5">
                    <asp:Button ID="Button3" runat="server" Text="حدیث قربانی" class="btn-secondary-nobg w-full py-3"  />
          </div>
              <div class="mb-5">
                    <asp:Button ID="Button4" runat="server" Text="علی فبک زاده" class="btn-secondary-nobg w-full py-3"  />
          </div>
            
              <div class="mb-5">
                    <asp:Button ID="Button5" runat="server" Text="بازگشت به صفحه اصلی" class="btn-primary w-full py-3" OnClick="Button5_Click"  />
          </div>
            </div>
