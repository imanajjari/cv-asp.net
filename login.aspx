<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="section_3._1._default" %>
...
<html dir="rtl" lang="fa">
  <head>
    ...
    <link href="./assets2/css/fonts.css" rel="stylesheet" />
  ...
  <body>
    ...
    <div
      class="flex min-h-screen items-center justify-center bg-secondary-light dark:bg-primary-dark"
    >
        
      <div class="container">
        <div
          class="mx-auto max-w-[450px] rounded-xl bg-primary-light p-5 shadow-base dark:bg-secondary-dark md:p-10"
        >
          <!-- Logo -->
          
            <img
              src="./assets2/images/logo.jpg"
              class="mx-auto mb-10 w-40"
              alt=""
            />
          
          <h1
            class="mb-10 text-center text-lg text-quaternary-700 dark:text-primary-light"
          >
          ...
          <div class="mb-4 space-y-4">
            ...
            >
                <asp:TextBox ID="TextBox1" dir="auto"
                ...
                placeholder="نام کاربری " runat="server"></asp:TextBox>
               
              <span
                class="pointer-events-none absolute start-2.5 top-0 -translate-y-1/2 bg-primary-light px-2 py-0.5 text-sm text-quaternary-600 transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-base peer-focus:top-0 peer-focus:text-sm dark:bg-secondary-dark dark:text-quaternary-300"
              >
                نام کاربری
              </span>
            </label>
            ...
            >
                ...
                <asp:TextBox ID="TextBox2" dir="auto"
                class="peer w-full rounded-lg border-none bg-transparent p-4 text-left text-quaternary-700 placeholder-transparent focus:outline-none focus:ring-0 dark:text-primary-light"
                placeholder="رمز عبور " runat="server"></asp:TextBox>
          ...
          <div class="mb-5">
                    <asp:Button ID="Button1" runat="server" Text="ورود" class="btn-primary w-full py-3" OnClick="Button1_Click"  />
          </div>
