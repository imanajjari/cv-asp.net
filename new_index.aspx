<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="new_index.aspx.cs" Inherits="section_3._1.new_index" %>
      ...
      <div class="container">
        ...
        >
            ...
            <div>
                ...
                <div class="row">
                      <div class="col-lg-12 form-item">
                        <div class="form-group" style="    display: flex; justify-content: center;    text-align-last: center;">
                          <%--<input name="name" id="name" type="text" >--%>
                            <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="جست و جو" required="" AutoPostBack="True" OnTextChanged="TextBox1_TextChanged" ></asp:TextBox> 
                        </div>
                      </div>
          ...
          <div class="mb-5">
              ...
              <div class="mb-5">
                    <asp:Button ID="Button5" runat="server" Text="بازگشت به صفحه اصلی" class="btn-primary w-full py-3"  />
          </div>
            </div>
